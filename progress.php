...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse text-center" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-semibold text-blue" href="#company">Curriculum Vitae</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-semibold text-blue" href="career.html">Career</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-semibold text-blue" href="progress.html">My Application</a>
                    </li>
                    <center>
    ...
    <div class="container py-3">
        ...
        <div class="heading" style="display: flex; flex-direction: row; justify-content: space-between;">
            <p style="font-size: 1.5vh">Kamu sedang berada di halaman : My Application / <b>Application Progress</b></p>
