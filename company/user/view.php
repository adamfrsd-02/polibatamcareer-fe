...
if(!$_SESSION['COMPANY_ROLE']=='Administrator'){
  ...
  @$USERID = $_SESSION['COMPANY_USERID'];
    if($USERID==''){
  redirect("index.php");
}
  $user = New User();
        ...
        <div class="col-md-4">
         <a  data-target="#myModal" data-toggle="modal" href="" title="Click here to Change Image." >
            <img alt="" style="width:500px; height:400px;>"
             title="" class="img-circle img-thumbnail isTooltip" src="<?php echo web_root.'assets/upload/company_logo/'. $singleuser->COMPANYLOGO;?>" data-original-title="Usuario"> 
         </a>  
        </div>
        <div class="col-md-6">
                      ...
                      <div class="col-md-8">
                        <input name="deptid" type="hidden" value="">
                         <input class="form-control input-sm" id="U_USERNAME" name="U_USERNAME" placeholder=
                            "Email Address" type="text" value="<?php echo $singleuser->COMPANYUSERNAME; ?>">
                      </div>
                    </div>
                  </div>
