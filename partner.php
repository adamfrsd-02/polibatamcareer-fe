    ...
    <div class="container py-5">
        <div class="header-partner mb-4">
            ...
            <div class="header-subtitle">
                <span class="header-subtitle">Ada <b class="highlighted">35 perusahaan</b> yang
                    yang bekerja sama dengan Polibatam</span>
            </div>
        </div>
        <div class="body-partner">
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    <div class="card p-4 px-3" style="width: auto; border-radius: 15px">
                        <div class="card-heading">
                            <div class="career-overview">
                                <div class="d-flex justify-content-between">
                                    <div class="mou-label bg-myblue text-white text-center my-auto py-2 px-5"
                                        style="border-radius: 15px;"><b>MoU</b>
                                    </div>
                                    <div class="salary text-start w-25">Batam, Indonesia</div>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="career-jobdesc py-2">
                                ...
                                <p class="job-overview">
                                    Perusahaan yang bergerak di bidang reparasi, perbaikan, serta perawatan gadget
                                    dengan teknisi dan peralatan yang berkualitas.
                                </p>
                            </div>
