...
<body>
    ...
    <div class="" id="career">
        <div class="lowker">
            ...
            <div class="container">
                <center>
                    <div class="footer">
                        <button class="btn btn-secondary">Lowongan Lainnya</button>
                    </div>
                </center>
            </div>
        </div>
    ...
    <div class="contact-us mt-5 pb-5 mb-4" id="contact">
        <div class="container py-4">
            ...
            <div class="body mt-5">
                <div class="row">
                    <div class="col-md-5 p-3 px-5 py-5" style="background-color: #183a64; border-radius: 10px">
                        <div class="content">
                            <div class="head">
                    ...
                    <div class="col-md-7 p-5" style="background-color: blanchedalmond">
                        <form action="">
                            <div class="row">
